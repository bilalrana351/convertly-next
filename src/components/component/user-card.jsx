...
* @see https://v0.dev/t/q8FKTj2FOQL
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      sender: "chatbot",
      text: "Hello, I am the Document Analysis Chatbot. How can I assist you today?",
    },
  ])
    ...
    if (inputText.trim() !== "") {
      ...
      setTimeout(() => {
        const chatbotResponse = {
          id: messages.length + 1,
          sender: "chatbot",
          text: "I'm sorry, I don't have enough information to provide a detailed response. Could you please provide more details about the document you would like me to analyze?",
        }
        ...
        <div className="bg-card rounded-lg shadow-md p-6 md:p-10">
          ...
          <div className="grid gap-4">
            {messages.map((message) => (
              <div
                key={message.id}
                className={`flex items-start gap-4 ${message.sender === "chatbot" ? "flex-row" : "flex-row-reverse"}`}>
                <Avatar>
                  <AvatarImage src="/placeholder-user.jpg" alt={message.sender} />
                  <AvatarFallback>{message.sender === "chatbot" ? "CB" : "U"}</AvatarFallback>
                </Avatar>
                <div
                  className={`flex-1 bg-muted rounded-lg p-4 ${
                    message.sender === "chatbot" ? "bg-primary text-primary-foreground" : ""
                  }`}>
                  <p>{message.text}</p>
                </div>
              </div>
